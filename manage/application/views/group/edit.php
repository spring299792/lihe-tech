...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="widget-box">
          ...
          <form action="<?=MANAGE_URL;?><?=base_url();?>group/insert" method="post" class="form-horizontal">
          <input type="hidden" name="id" value="<?if(isset($row['id'])){ echo $row['id'];}?>" />
            <div class="control-group">
              <label class="control-label">群组名称 :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="群组名称" name="title" value="<?if(isset($row['title'])){ echo $row['title'];}?>" />
              </div>
            </div>
            <div class="control-group">
