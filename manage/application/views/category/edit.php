    ...
    <div class="widget-box">
          ...
          <input type="hidden" name="type" value="<?if(isset($type)){ echo $type;}else{ echo $row['type'];}?>" />
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span5" placeholder="分类名称" name="name" value="<?if(isset($row['name'])){ echo $row['name'];}?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">排序 :</label>
              <div class="controls">
              <input type="text" class="span5" placeholder="排序" name="sort" value="<?if(isset($row['sort'])){ echo $row['sort'];}?>" />
