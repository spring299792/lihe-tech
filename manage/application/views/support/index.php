  ...
  <div class="container-fluid">
    <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-pushpin"></i></span>
            <h5>伙伴资质列表</h5>
            <span style="float:right;margin:7px;"><a href="<?=MANAGE_URL;?><?=base_url();?>support/add/" class="btn btn-success">添加信息</a></span>
          </div>
            ...
            <thead>
              ...
              <?foreach($list as $vo):?>
                <tr class="gradeX">
                  ...
                  <td width="30%"><img src="<?=WEB_URL.'/data/news/'.$vo['img']?>" width="150" alt=""></td>
                  <td width="4%"><?echo date("Y-m-d",$vo['create_time']);?></td>

                  <td width="10%"><a href="<?=MANAGE_URL;?><?=base_url();?>support/edit?id=<?=$vo['id']?>">编辑</a>　　<a href="javascript:;" onclick="return delcheck(<?=$vo['id']?>);">删除</a></td>
                </tr>
              <?endforeach;?>
              </tbody>
            </table>
...
$(".status").each(function(){
  ...
  function delcheck(id){
    ...
    location.href="<?=MANAGE_URL;?><?=base_url();?>support/del?id="+id
})
  }
