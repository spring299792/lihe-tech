  ...
  <div class="container-fluid">
    <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-pushpin"></i></span>
            <h5>反馈管理</h5>
            <span style="float:right;margin:7px;"><a href="<?=MANAGE_URL;?><?=base_url();?>feedback/add/" class="btn btn-success">添加幻灯</a></span>
          </div>
            ...
            <thead>
              ...
              <?foreach($list as $vo):?>
                <tr class="gradeX">
                  ...
                  <td width="4%"><?=$vo['tel'];?></td>
                  <td width="8%"><?=$vo['email'];?></td>
                  <td width="10%"><a href="<?=MANAGE_URL;?><?=base_url();?>feedback/edit?id=<?=$vo['id']?>">详情</a>　　<a href="javascript:;" onclick="return delcheck(<?=$vo['id']?>);">删除</a></td>
                </tr>
              <?endforeach;?>
              </tbody>
            </table>
